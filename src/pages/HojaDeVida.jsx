    ...
    <div>
      <div class="columnas">
        <div class="sidebar">
          ...
          <div class="bordeimagen">
            <img
              class="radioimagen"
              src="../media/FotoBuena.png"
              alt="Foto De Perfil"
            />
          </div>
          <div class="Datos">
            <div class="titulosDescriptivos">
              <h2 class="movertitulo titulosTecnologia">Habilidades</h2>
            </div>
            <ul>
              <li>
                <h3>Dominio De Java Script, Java, Python CSS3 HTML5</h3>
              </li>
              <li>
                <h3>Conocimiento De Las Bases De Datos</h3>
              </li>
              <li>
                <h3>MongoDB</h3>
              </li>
            ...
            <div class="separadodetextotecnologias">
              <span>HTML5</span>
              <span class="separadodetextotecnologias2">NodeJS</span>
              <span class="separadodetextotecnologias2">CSS3</span>
            </div>
            <div class="unioncolumnas">
              <img
                class="imagenReact"
              ...
              <img
                class="imagenReact"
                src="../media/JavaScript.png"
                alt="Imagen React"
              />
            </div>
            <div class="separadodetextotecnologias">
              <span>TypeScript</span>
              <span class="separadodetextotecnologias">MongoDB</span>
              <span class="separadodetextotecnologias">JavaScript</span>
            </div>
            <div>
              <div>
                <div class="titulodecontacto">
                  <h2 class="movertitulo titulosTecnologia">Contacto</h2>
                </div>
                <div iv>
                  <i class="fas fa-phone-alt telefonounion">
                    <h3 class="telefonounion">Teléfono</h3>
                  </i>
                </div>
                ...
                <div class="margin-top">
                  <i class="fas fa-map-marker-alt ubicacionunion">
                    <h3 class="ubicacionunion ubicacionunion2">
                      Colombia-Bogotá D.C
                    </h3>
                  </i>
                </div>
      ...
      <div>
        ...
        <h1 class="DescripcionCV justificartexto">
          ...
          con tecnologías como React, HTML5, NodeJS, MongoDB, CSS3 entre otros.
          Tambien tengo Conocimiento de PLC´S Siemens, actualmente haciendo
          proyectos de Domótica, cursos de programación, Diplomado en
        ...
        <div class="columnas">
          <div class="fechaexperiencia">
            2018- <br></br> 2019
          </div>
          <div class="DescripcionEmpresa">
            <h2 class="quitarmargin">Programador De Robots De Sumo</h2>
            <h3 class="colocarmarginbottom">Ja-Bots</h3>
            <ul>
              <li class="justificartexto">
                ...
                programa Arduino y con la tarjeta de desarrollo MiniBlack, para
                tener las diferentes tácticas en la competición y poder ganar al
                contrincante con las diferentes programaciones plasmadas como
                rutinas estratégicas. Se usa programación java orientada a
                objetos.
              </li>
              <li>
                Soldar los diferentes componentes electrónicos tarjetas
                controladoras y demás para su funcionamiento circuital.
              </li>
              <li>
                Ensamble de todas las piezas del robot para su correcto
                funcionamiento.
              </li>
            </ul>
          </div>
        ...
        <div class="columnas margin-top-a-titulos-educacion">
          ...
          <div class="DescripcionEmpresa">
            ...
            <ul>
              ...
              <li class="justificartexto">
                Realizar visitas regularmente a los puestos de salud y verificar
                los avances de las diferentes sedes del proyecto, realizando
                informe para las mismas, verificar la entrega y la instalación,
                configuración y puesta en marcha para los equipos entregados
                durante el proyecto (Access Point, switch capa 2, servidores,
                firewall, nodo de hiperconvergencia, UPS, tablero red regulada y
                puntos de red), además de realizar el levantamiento de las actas
        ...
        <div class="columnas margin-top-a-titulos-educacion">
          ...
          <div class="DescripcionEmpresa">
            ...
            <ul>
              <li>
                Programador de tarjetas NodeMCU, ESP8266, Módulo ESP-12E y sus
                diferentes gamas, todo enfocado hacia el sector domótico.
              </li>
              <li>
        ...
        <div class="columnas margin-top-a-titulos-educacion">
          ...
          <div class="DescripcionEmpresa">
            <h2 class="quitarmargin">Ingeniero En Reparación Electrónica</h2>
            ...
            <ul>
              <li class="justificartexto">
                ...
                Re-manufacturación para las principales empresas que prestan el
                servicio de televisión y telefonía hogar (Claro, Une, Tigo, ETB)
                .
              </li>
            </ul>
          </div>
        ...
        <div class="columnas margin-top-a-titulos-educacion">
          ...
          <div class="DescripcionEmpresa">
            <h2 class="quitarmargin">
              Universidad Distrital Francisco José De Caldas
            </h2>
            <h3 class="colocarmarginbottom">
              Monitor De Laboratorio en la sala de Ciencias Básicas Y Software
            </h3>
            <ul>
              <li>Asistencia a los diferentes docentes sobre informática.</li>
              <li>
                Manejo de Matlab y capacitación de la misma a los estudiantes.
              </li>
              <li>
                Manejo de tablero electrónico para disposición de los docentes.
              </li>
              <li>
                Manejo de equipo multimedia como lo es video Beam, audio ETC.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="columnas">
          ...
          <div class="DescripcionEmpresa">
            <h1 class="quitarmargin">
              Universidad Distrital Francisco José De Caldas
            </h1>
            <h3 class="colocarmarginbottom">
              Ingenieria En Control y Autorización
            </h3>
            <ul>
              <li class="justificartexto">
                Ingeniero En Control Y Automatización con conocimientos en
                electrónica, instrumentación, automatización y control; manejo
                lenguajes de programación como C++, Java, LabVIEW, Python,
                Matlab, R studio, JavaScript para desarrollo de páginas WEB con
                tecnologías como React, HTML5, Nodejs, CSS3 entre otros.
                Conocimiento de PLC´S Siemens, actualmente haciendo proyectos de
                Domótica, cursos de programación, Diplomado en programación en
                la universidad de Antioquia y Beca por medio de BIT Bogotá
        ...
        <div class="columnas margin-top-a-titulos-educacion">
          ...
          <div class="DescripcionEmpresa">
            <h1 class="quitarmargin">
              Diplomado en habilidades en programación con énfasis en
              aplicaciones Web.
            </h1>
            <h3 class="colocarmarginbottom">
              Certificado Realidado En La Universidad De Antioquia (+800 Horas)
            </h3>
            <ul>
              <li>
                {" "}
                Lenguajes (JavaScript, TypeScript, Java, Python), Bases De Datos
                NoSQL (MongoDB) No Relacional, Integración Backend & Frontend
                (Stack MEAN / MERN), Contenedores Para Apps (Docker),
                Integración A GraphQL Con NodeJS, Despliegue en Entornos Cloud
                (PassS), Gestión De La Configuración Del Software (Git / GitHub
                / SourceTree) entre otros.
              </li>
            </ul>
          </div>
        </div>
        <div class="columnas margin-top-a-titulos-educacion">
          ...
          <div class="DescripcionEmpresa">
            <h1 class="quitarmargin">BIT (Bogotá Institute Of Technology)</h1>
            <h3 class="colocarmarginbottom">
        ...
        <div class="margindelpiedepagina">
          <div class="columnas margin-top-a-titulos-educacion">
            <div class="fechaexperiencia">
              2012- <br></br> 2013
            </div>
            <div class="DescripcionEmpresa">
              <h1 class="quitarmargin">Academia De Sistemas Nuevo Milenio.</h1>
              <h3 class="colocarmarginbottom">
                Técnico en sistemas. (Técnico profesional en mantenimiento de
                computadores, técnicas empresariales de digitación)
              </h3>
              <ul>
                <li>
...
//     <link rel="stylesheet" href="../styles/stylesPersonajesBuenos.css" />
//     <link rel="stylesheet" href="../styles/stylesPersonajesMalos.css" />
//     <link rel="icon" href="../media/FotoBuena.ico" />
...
//           <i class="fab fa-linkedin telefonounion sepadodesitiosweb">
//             <h3 class="telefonounion">
//               <a class="color-a-sitios-web" href="https://www.linkedin.com/in/jdbarajass/">LinkedIn</a></h3>
//           </i>
//           <i class="fab fa-github telefonounion sepadodesitiosweb">
//             <h3 class="telefonounion">
//               <a class="color-a-sitios-web" href="https://github.com/jdbarajass">GitHub</a>
//               </h3>
//           </i>
//           <div class="margin-top">
//             <i class="fas fa-map-marker-alt ubicacionunion">
...
//         </div>
//         <h1 class="DescripcionCV justificartexto">
//           Ingeniero En Control Y Automatización egresado de la universidad distrital francisco José de caldas, de Bogotá, Colombia; Tengo conocimientos en electrónica, instrumentación, automatización y control; manejo lenguajes de programación como C++, Java, LabVIEW, Python, Matlab, R studio, JavaScript para desarrollo de páginas WEB con tecnologías como React, HTML5, NodeJS, MongoDB, CSS3 entre otros. Tambien tengo Conocimiento de PLC´S Siemens, actualmente haciendo proyectos de Domótica, cursos de programación, Diplomado en programación en la universidad de Antioquia y Beca por medio de BIT Bogotá Institute Of Technology, mantenimiento de cómputo, Soporte sistemas operativos y diferentes Windows, ofimática, conocimiento básico en Linux, diseño de páginas web, técnicas empresariales de digitación.
...
//             <div class="fechaexperiencia">2018- <br> 2019</div>
//             <div class="DescripcionEmpresa">
//               <h2 class="quitarmargin">Universidad Distrital Francisco José De Caldas</h2>
//               <h3 class="colocarmarginbottom">Monitor De Laboratorio en la sala de Ciencias Básicas Y Software</h3>
//               <ul>
//                 <li>Asistencia a los diferentes docentes sobre informática.</li>
...
//           </div>
//           <div class="columnas">
//             <div class="fechaexperiencia">2021- <br> 2022</div>
//             <div class="DescripcionEmpresa">
...
//         </div>
//         <div class="columnas margin-top-a-titulos-educacion">
//             <div class="fechaexperiencia">2021- <br> 2021</div>
//             <div class="DescripcionEmpresa">
...
//             <div class="DescripcionEmpresa">
//               <h1 class="quitarmargin">BIT (Bogotá Institute Of Technology)</h1>
//               <h3 class="colocarmarginbottom">BootCamp Desarrollo Web Full Stack</h3>
//               <ul>
//                 <li>
//                 Desarrollo FronEnd
//               </li>
...
//         <div class="margindelpiedepagina">
//           <div class="columnas margin-top-a-titulos-educacion">
//               <div class="fechaexperiencia">2012- <br> 2013</div>
//               <div class="DescripcionEmpresa">
//                 <h1 class="quitarmargin">Academia De Sistemas Nuevo Milenio.</h1>
//                 <h3 class="colocarmarginbottom">Técnico en sistemas. (Técnico profesional en mantenimiento de computadores, técnicas empresariales de digitación)</h3>
//                 <ul>
//                    <li>
//                   Mantenimiento De Equipos De Cómputo (Software y Hardware)
//                 </li>
...
//           <ul>
//             <li>
//               Permiso para conducir B1 y moto propia
//             </li>
//             <li>
